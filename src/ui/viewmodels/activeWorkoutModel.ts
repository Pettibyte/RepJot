...
/**
 * The Last Time badge content.
 *
 * The type lives in `lastTimeModel.ts`, which holds the read behind the badge
 * and the type it returns. It is re-exported here so the Active Workout
 * surface keeps one import site. REQUIREMENTS 19.3-19.5.
 */
export type { LastTimeModel } from './lastTimeModel';
